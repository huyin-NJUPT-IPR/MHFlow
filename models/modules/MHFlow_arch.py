...
from models.modules.low_light_transformer import low_light_transformer


class MHFlow(nn.Module):
    def __init__(self, K=None, opt=None, step=None):
        super(MHFlow, self).__init__()
        ...
        if opt['cond_encoder'] == 'ConEncoder1':
            self.RRDB = low_light_transformer(nf=96, n_layer=3, HR_in=True)
