...
class TransformerBlock(nn.Module):
    def __init__(self, dim, num_heads=6, ffn_expansion_factor=2.66, bias=False, LayerNorm_type='WithBias'):
...
if __name__ == "__main__":
    ...
    model = Restormer()
    # y = model(x)
    print("Parameters of full network %.4f and encoder %.4f" % (sum([m.numel() for m in model.parameters()]) / 1e6,
